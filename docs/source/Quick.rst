...
This part aims to provide a quick overview on how to provide paramaters to run Pecube as is usually done with a terminal. For more details about extended tools provided with PecubeGUI, please refer to :doc:`Usage`.
